...
const Simulator = () => {
    ...
    return (
      <div>
        <div className='py-10 flex flex-col gap-10 ml-[200px] w-calc '>
            {estimateOpen && <Estimation estimateOpen={estimateOpen} setEstimateOpen={setEstimateOpen} brand={brand} model={model} resultAlgo={resultAlgo} />}
